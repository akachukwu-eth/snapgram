...
const Profile = () => {
  ...
  const followClick = () => {
    if (window.innerWidth <= 768) {
      // Show mobile-friendly alert for follow feature unavailability
      alert("Feature Unavailable, Coming Soon.");
    } else {
      // Show toast for follow feature unavailability on desktop
      toast({
        title: "Feature Unavailable: Coming Soon.",
      });
    }
  };
  ...
  const showBadge = currentUser.username === "therealakach";
  return (
        ...
        <div className="flex xl:flex-row flex-col max-xl:items-center flex-1 gap-7">
          ...
          <div className="flex justify-center gap-4">
            ...
            <div className={`${user.id === id && "hidden"}`}>
              <Button type="button" onClick={followClick} className="shad-button_primary px-8">
                Follow
              </Button>
            </div>
          </div>
